...
async function init(json) {
    ...
    if (data.munPrestador != data.codIBGEMunicipioNota) {
        data.munPrestador = data.codIBGEMunicipioNota;
    }
    if (data.munPrestador == data.munTomador) {
        data.cadastro_no_cpom = 'Cadastrado no CEPOM';
    }
    //?return SetObjectResponse(data.munPrestador == data.munTomador, data, false);
    return true;
}
