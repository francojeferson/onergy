...
function init(json) {
    ...
    let execCargExcelFdtId = '02a03b73-d37b-4eb8-8b65-4ae9165e566b'; // id do proximo card do processo
...
function initDelete(json) {
    ...
    var idSalvo = data.CIP_id_card_pagamentos; // id do card onde será gravado os registros
    let postInfoDelet = {
        UrlJsonContext: {
    ...
    onergy_updatemany({
        fdtid: idSalvo, // id do card que recebe a importação da planilha
