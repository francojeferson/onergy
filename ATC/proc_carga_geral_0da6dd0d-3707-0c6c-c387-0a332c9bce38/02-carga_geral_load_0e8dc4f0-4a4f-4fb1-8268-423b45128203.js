            ...
            if (arrayPost.length > 0) {
                ...
                for (let y in arrayPost) {
                    ...
                    if (tabExcel == 'categorias') {
                        ...
                        if (!duplicadorCategoria || data.em_caso_de_duplicidade == '1') {
                    ...
                    if (tabExcel == 'estado_legalizacion') {
                        ...
                        if (!duplicadorEstadoLegalizacao || data.em_caso_de_duplicidade == '1') {
                    ...
                    if (tabExcel == 'medidores_sitio') {
                        ...
                        if (!duplicadorMedidoresSitio || data.em_caso_de_duplicidade == '1') {
                    ...
                    if (tabExcel == 'proveedores') {
                        ...
                        if (!duplicadorDiaVencimento || data.em_caso_de_duplicidade == '1') {
                    ...
                    if (tabExcel == 'informacion_cuenta') {
                        ...
                        if (!duplicadorMediaValorTotal || data.em_caso_de_duplicidade == '1') {
                        ...
                        if (!duplicadorMediaValorEnergia || data.em_caso_de_duplicidade == '1') {
                        ...
                        if (!duplicadorMediaValorIluminacao || data.em_caso_de_duplicidade == '1') {
                        ...
                        if (!duplicadorUltimaCaptura || data.em_caso_de_duplicidade == '1') {
                        ...
                        if (!duplicadorStatusCapturaConta || data.em_caso_de_duplicidade == '1') {
                        ...
                        if (!duplicadorProximaCaptura || data.em_caso_de_duplicidade == '1') {
                        ...
                        if (!duplicadorProximoPagoOportuno || data.em_caso_de_duplicidade == '1') {
...
let json = {
    ...
    load_index_id_do_card: 'a95b4721-fc79-445c-b964-14a4ccbf1d7b',
    planilha: [
        {
    ...
    load_index_tab_excel: 'municipio',
