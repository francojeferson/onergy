...
function init(json) {
    ...
    let execCargExcelFdtId = '0e8dc4f0-4a4f-4fb1-8268-423b45128203'; // id do proximo card do processo
...
function initDelete(json) {
    ...
    var idSalvo = data.load_index_id_do_card; // id do card onde será gravado os registros
    let postInfoDelet = {
        UrlJsonContext: {
