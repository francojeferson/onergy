        ...
        for (let line in arrayInfo) {
            ...
            if (atividadesFdtid == sitesGrid) {
                ...
                if (atividadesFdtid == sitesGrid) {
                    ...
                    if (retornoPortfolio.length == 0) {
                        ...
                        if (equipe == 'BRA') {
                            status_erro =
                                '**ERRO PORTIFÓLIO não encontrado ' + arrayInfo[line].tppf_tipo_portifolio__portfolio + ' | LINHA: ' + String(linha + 1);
                        }
                        break;
                    }
                }
            ...
            if (atividadesFdtid == medidoresGrid) {
                ...
                if (newData !== undefined) {
                    ...
                    dataLiga =
                        dataLiga.getFullYear() +
                        '-' +
                        (dataLiga.getMonth() + 1).toString().padStart(2, 0) +
                        '-' +
                        dataLiga.getDate(null).toString().padStart(2, 0) +
                        ' 00:00:00';
                } else {
                    dataLiga = undefined;
                }
                ...
                if (newDataPro !== undefined) {
                    ...
                    dataPro =
                        dataPro.getFullYear() +
                        '-' +
                        (dataPro.getMonth() + 1).toString().padStart(2, 0) +
                        '-' +
                        dataPro.getDate().toString().padStart(2, 0) +
                        ' 00:00:00';
                } else {
                    dataPro = undefined;
                }
                ...
                if (newDataCadas !== undefined) {
                    ...
                    dataCadas =
                        dataCadas.getFullYear() +
                        '-' +
                        (dataCadas.getMonth() + 1).toString().padStart(2, 0) +
                        '-' +
                        dataCadas.getDate().toString().padStart(2, 0) +
                        ' 00:00:00';
                } else {
                    dataCadas !== undefined;
                }
                ...
                if (newDataConf !== undefined) {
                    ...
                    dataConf =
                        dataConf.getFullYear() +
                        '-' +
                        (dataConf.getMonth() + 1).toString().padStart(2, 0) +
                        '-' +
                        dataConf.getDate().toString().padStart(2, 0) +
                        ' 00:00:00';
                } else {
                    dataConf = undefined;
                }
                ...
                if (atividadesFdtid == medidoresGrid) {
                    var retornoStatusConferencia = registroStatusConferencia.filter(
                        (x) => x.UrlJsonContext.status_conferencia == arrayInfo[line]['Status Conferência']
                    );
                    if (retornoStatusConferencia.length == 0) {
                        let linha = parseInt(line + 1);
                        if (equipe == 'BRA') {
                            status_erro =
                                '** ERROR Status Conferência não encontrado ' + arrayInfo[line]['Status Conferência'] + ' | LINHA: ' + String(linha + 1);
                        }
                        break;
                    }
                }
            ...
            if (atividadesFdtid == informacionCuenta) {
                ...
                objItem.FORPAGformas_de_pagamentos__forma_de_pagamento = retornoFormaPagamento[0]
