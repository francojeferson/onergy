function init() {
    ...
    var assid = "f8387e95-c604-454b-820e-e01c8dbedfcf";
    var usrid = "31805071-d12a-43a0-9651-9f67f9ea39e7";
    ...
    if (json.init === "NFSE") {
        ...
        datatosend = {
            ...
            urlpdf: "https://gateway.taxfy.com.br/v1/api/nfe/danfe?subscription-key=4220c09ea0dd470cb3c130dbbf0863d2&cusid=" + json.telanfe.cusId + "&id=" + json.telanfe.id + "&subid=" + json.telanfe.subId,
        ...
        datatosend = {
            ...
            urlpdf: "https://gateway.taxfy.com.br/v1/api/cte/dacte?subscription-key=4220c09ea0dd470cb3c130dbbf0863d2&cusid=" + json.telacte.CusId + "&id=" + json.telacte.Id + "&subid=" + json.telacte.SubId,
            ...
            urldacte: "https://gateway.taxfy.com.br/v1/api/cte/dacte?subscription-key=4220c09ea0dd470cb3c130dbbf0863d2&cusid=" + json.telacte.CusId + "&id=" + json.telacte.Id + "&subid=" + json.telacte.SubId,
        };
